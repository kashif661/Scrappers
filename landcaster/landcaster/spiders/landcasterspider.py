...
class LandcasterspiderSpider(scrapy.Spider):
    name = "landcasterspider"

    start_urls = ["https://paperless.lancastercountypa.gov/psi3/v/search/case"]
    def __init__(self, *args, **kwargs):
        super(LandcasterspiderSpider, self).__init__(*args, **kwargs)
        self.datefrom_str = kwargs.get('datefrom_str')
        self.dateto_str = kwargs.get('dateto_str')

    Cookie = {
        'ASP.NET_SessionId': 'a01gj4hmhpbbodt2hyec15py', 
        'PSIUserGuid': '156dff1c-7971-4f25-9adc-aa94fa7bdd57', 
        'PSIAuthProd': '' ,
        'SearchResultsAsGrid': 'True',
        'LancoLastSearchUrl' : 'https://paperless.lancastercountypa.gov/psi3/v/search/case'
    }
    headers = {
    ...
    #     start_url = "https://paperless.lancastercountypa.gov/psi3/v/search/case"
    ...
    def parse(self, response):
        ...
        url = "https://paperless.lancastercountypa.gov/psi3/v/search/case?" + urlencode(params)
        meta_data = {
            'count': '20',
        }
    ...
    def case_listing(self, response):
        ...
        for link in links:
            url = "https://paperless.lancastercountypa.gov" + link
            # url = "https://paperless.lancastercountypa.gov/psi3/v/detail/Case/142506"
    ...
    def case(self, response):
        ...
        filling_date = response.css('.ViewerDetail tr:nth-child(3) td').css('::text').extract_first()
        if filling_date:
        ...
        if case_title is not None:
            ...
            case_title = ""
        case_type = response.css('.ViewerDetail tr:nth-child(8) td').css('::text').extract_first()
        if case_type is not None:
            case_type = case_type.title()
        else:
            case_type = ""
        case_status = response.css('.ViewerDetail tr:nth-child(5) td').css('::text').extract_first()
    ...
    def case_details(self, response):
        ...
        try:
            personal_representatives = personal_representatives.replace("Peoplesbank", "").strip()
        except:
            pass
        ...
        if decedent:
            ...
            try:
                ...
                my_data['Decedent_First_Name'] = decedent_parsed_name['first_name'].title()
                if 'middle_name' in decedent_parsed_name:
                    my_data['Decedent_Middle_Name'] = decedent_parsed_name['middle_name'].title()
                my_data['Decedent_Last_Name'] = decedent_parsed_name['last_name'].title()
                my_data['Decedent_Suffix'] = decedent_parsed_name['suffix'].title()
            except:
                pass
        else:
        ...
        try:
            if "Confidential" in decedent_address:
                decedent_address = ""
            try:
                decedent_address = decedent_address.replace("Unknown", "").strip()
            except:
                pass
              
            parsed_decedent_address = parser.lf_address_parser(decedent_address)
            my_data['Decedent_Address'] = (parsed_decedent_address["address1"])
        ...
        personal_representatives1 = personal_representatives1.replace("Security National Trust Company", "").strip()
        personal_representatives1 = personal_representatives1.replace("Peoplesbank", "").strip()
        ...
        if personal_representatives1:          
            try:    
                ...
                my_data['Petitioner1_First_Name'] = personal_representatives1_parsed_name['first_name'].title()
                if 'middle_name' in personal_representatives1_parsed_name:
                    my_data['Petitioner1_Middle_Name'] = personal_representatives1_parsed_name['middle_name'].title()
                my_data['Petitioner1_Last_Name'] = personal_representatives1_parsed_name['last_name'].title()
                my_data['Petitioner1_Suffix'] = personal_representatives1_parsed_name['suffix'].title()
            except:
                pass
        else:
        ...
        try:
            try:
                personal_representatives_address1 = personal_representatives_address1.replace("Unknown", "").strip()
            except:
                pass
        
            parsed_personal_representatives1_address = parser.lf_address_parser(personal_representatives_address1)
            my_data['Petitioner1_Address'] = (parsed_personal_representatives1_address["address1"])
        ...
        personal_representatives2 = personal_representatives2.replace("Security National Trust Company", "").strip()
        personal_representatives2 = personal_representatives2.replace("Peoplesbank", "").strip()
        ...
        if personal_representatives2:      
            try:
                ...
                my_data['Petitioner2_First_Name'] = personal_representatives2_parsed_name['first_name'].title()
                if 'middle_name' in personal_representatives2_parsed_name:
                    my_data['Petitioner2_Middle_Name'] = personal_representatives2_parsed_name['middle_name'].title()
                my_data['Petitioner2_Last_Name'] = personal_representatives2_parsed_name['last_name'].title()
                my_data['Petitioner2_Suffix'] = personal_representatives2_parsed_name['suffix'].title()
            except:
                pass
        else:
        ...
        try:
            try:
                personal_representatives_address2 = personal_representatives_address2.replace("Unknown", "").strip()
            except:
                pass
            
            parsed_personal_representatives2_address = parser.lf_address_parser(personal_representatives_address2)
            my_data['Petitioner2_Address'] = (parsed_personal_representatives2_address["address1"])
            ...
            if personal_representatives1 != person and personal_representatives2 != person:
                ...
                if my_data_key in my_data:
                    ...
                    try:
                        ...
                        my_data['Relatives' + str(i) + '_Address'] = (parsed_address["address1"])
                    ...
                    try:
                        ...
                        my_data['Relatives' + str(i) + '_First_Name'] = parsed_person['first_name'].title()
                        if 'middle_name' in parsed_person:
                            my_data['Relatives' + str(i) + '_Middle_Name'] = parsed_person['middle_name'].title()
                        my_data['Relatives' + str(i) + '_Last_Name'] = parsed_person['last_name'].title()
                        my_data['Relatives' + str(i) + '_Suffix'] = parsed_person['suffix'].title()
                    except:
                        pass
                    i = i + 1
                else:
        ...
        if attorny_url:
            ...
            url = 'https://paperless.lancastercountypa.gov/psi3/v/detail/' + PrLink + '/' + PrId + '/data'
            payload = json.dumps({})
        ...
        try:
            ...
            if attorney_name:
                ...
                try:
                    ...
                    attorney_first_name = attorney_parsed_name['first_name'].title()
                    if 'middle_name' in attorney_parsed_name:
                        attorney_middle_name = attorney_parsed_name['middle_name'].title()
                    attorney_last_name = attorney_parsed_name['last_name'].title()
                    attorney_suffix = attorney_parsed_name['suffix'].title()
                except:
                    pass
            ...
            try:
                ...
                try:
                    attorney_address = attorney_address.replace("Unknown", "").strip()
                except:
                    pass
              
                parsed_attorney_address = parser.lf_address_parser(attorney_address)
                attorney_add = parsed_attorney_address["address1"]
            ...
            attorney_name = ''
            attorney_address = ''
        my_data["Attorney1_Full_Name"] = attorney_name.title()
